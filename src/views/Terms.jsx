      ...
      <main className={styles["terms-main"]}>
        ...
        <div className={styles["terms-container"]}>
            <div className={styles["terms-header"]}>
                <h2 className={styles["subtitle"]}>Last modified: 7/27/2023</h2>
                <h1 className={styles["heading"]}>U.S. Terms of Use</h1>
            </div>
            <div className={styles["terms-body"]}>
                <p>
                    ...
                    We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by preptifyco@gmail.com, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.
                    ...
                    <p className={styles["body-subheading"]}>TABLE OF CONTENTS</p>

                    <br/>1. OUR SERVICES
                    <br/>2. INTELLECTUAL PROPERTY RIGHTS
                    <br/>3. USER REPRESENTATIONS
                    <br/>4. USER REGISTRATION
                    <br/>5. PURCHASES AND PAYMENT
                    <br/>6. FREE TRIAL
                    <br/>7. CANCELLATION
                    <br/>8. PROHIBITED ACTIVITIES
                    <br/>9. USER GENERATED CONTRIBUTIONS
                    <br/>10. CONTRIBUTION LICENSE
                    <br/>11. THIRD-PARTY WEBSITES AND CONTENT
                    <br/>12. ADVERTISERS
                    <br/>13. SERVICES MANAGEMENT
                    <br/>14. PRIVACY POLICY
                    <br/>15. TERM AND TERMINATION
                    <br/>16. MODIFICATIONS AND INTERRUPTIONS
                    <br/>17. GOVERNING LAW
                    <br/>18. DISPUTE RESOLUTION
                    <br/>19. CORRECTIONS
                    <br/>20. DISCLAIMER
                    <br/>21. LIMITATIONS OF LIABILITY
                    <br/>22. INDEMNIFICATION
                    <br/>23. USER DATA
                    <br/>24. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
                    <br/>25. CALIFORNIA USERS AND RESIDENTS
                    <br/>26. MISCELLANEOUS
                    <br/>27. CONTACT US


                    <p className={styles["body-subheading"]}>1. OUR SERVICES</p>
                    ...
                    <p className={styles["body-subheading"]}>2. INTELLECTUAL PROPERTY RIGHTS</p>

                    <br/>Our intellectual property
                    ...
                    <br/><br/>Your use of our Services

                    <br/><br/>Subject to your compliance with these Legal Terms, including the "PROHIBITED ACTIVITIES" section below, we grant you a non-exclusive, non-transferable, revocable license to:
                    ...
                    If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: preptifyco@gmail.com. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.

                    We reserve all rights not expressly granted to you in and to the Services, Content, and Marks.

                    Any breach of these Intellectual Property Rights will constitute a material breach of our Legal Terms and your right to use our Services will terminate immediately.

                    <br/><br/>Your submissions

                    <br/><br/>Please review this section and the "PROHIBITED ACTIVITIES" section carefully prior to using our Services to understand the (a) rights you give us and (b) obligations you have when you post or upload any content through the Services.
                    ...
                    <br/>You are responsible for what you post or upload: By sending us Submissions through any part of the Services you:
                    ...
                    <p className={styles["body-subheading"]}>3. USER REPRESENTATIONS</p>

                    <br/>By using the Services, you represent and warrant that: (1) all registration information you submit will be true, accurate, current, and complete; (2) you will maintain the accuracy of such information and promptly update such registration information as necessary; (3) you have the legal capacity and you agree to comply with these Legal Terms; (4) you are not a minor in the jurisdiction in which you reside, or if a minor, you have received parental permission to use the Services; (5) you will not access the Services through automated or non-human means, whether through a bot, script or otherwise; (6) you will not use the Services for any illegal or unauthorized purpose; and (7) your use of the Services will not violate any applicable law or regulation.

                    If you provide any information that is untrue, inaccurate, not current, or incomplete, we have the right to suspend or terminate your account and refuse any and all current or future use of the Services (or any portion thereof).

                    <p className={styles["body-subheading"]}>4. USER REGISTRATION</p>

                    <br/>You may be required to register to use the Services. You agree to keep your password confidential and will be responsible for all use of your account and password. We reserve the right to remove, reclaim, or change a username you select if we determine, in our sole discretion, that such username is inappropriate, obscene, or otherwise objectionable.

                    <p className={styles["body-subheading"]}>5. PURCHASES AND PAYMENT</p>

                    <br/>We accept the following forms of payment:
                    ...
                    <p className={styles["body-subheading"]}>6. FREE TRIAL</p>

                    <br/>We offer a 3-day free trial to new users who register with the Services. The account will be charged according to the user's chosen subscription at the end of the free trial.

                    <p className={styles["body-subheading"]}>7. CANCELLATION</p>

                    <br/>All purchases are non-refundable. You can cancel your subscription at any time by logging into your account. Your cancellation will take effect at the end of the current paid term.

                    If you are unsatisfied with our Services, please email us at preptifyco@gmail.com or call us at 5122997821.

                    <p className={styles["body-subheading"]}>8. PROHIBITED ACTIVITIES</p>

                    <br/>You may not access or use the Services for any purpose other than that for which we make the Services available. The Services may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us.
                    ...
                    <br/>- Use the Services to advertise or offer to sell goods and services.

                    <p className={styles["body-subheading"]}>9. USER GENERATED CONTRIBUTIONS</p>
                    ...
                    <p className={styles["body-subheading"]}>10. CONTRIBUTION LICENSE</p>

                    <br/>You and Services agree that we may access, store, process, and use any information and personal data that you provide and your choices (including settings).
                    ...
                    <p className={styles["body-subheading"]}>11. THIRD-PARTY WEBSITES AND CONTENT</p>
                    ...
                    <p className={styles["body-subheading"]}>12. ADVERTISERS</p>

                    <br/>We allow advertisers to display their advertisements and other information in certain areas of the Services, such as sidebar advertisements or banner advertisements. We simply provide the space to place such advertisements, and we have no other relationship with advertisers.

                    <p className={styles["body-subheading"]}>13. SERVICES MANAGEMENT</p>
                    ...
                    <p className={styles["body-subheading"]}>14. PRIVACY POLICY</p>

                    <br/>We care about data privacy and security. By using the Services, you agree to be bound by our Privacy Policy posted on the Services, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.

                    <p className={styles["body-subheading"]}>15. TERM AND TERMINATION</p>
                    ...
                    <p className={styles["body-subheading"]}>16. MODIFICATIONS AND INTERRUPTIONS</p>
                    ...
                    <p className={styles["body-subheading"]}>17. GOVERNING LAW</p>

                    <br/>These Legal Terms and your use of the Services are governed by and construed in accordance with the laws of the State of Texas applicable to agreements made and to be entirely performed within the State of Texas, without regard to its conflict of law principles.

                    <p className={styles["body-subheading"]}>18. DISPUTE RESOLUTION</p>
                    ...
                    <br/>If the Parties are unable to resolve a Dispute through informal negotiations, the Dispute (except those Disputes expressly excluded below) will be finally and exclusively resolved by binding arbitration. YOU UNDERSTAND THAT WITHOUT THIS PROVISION, YOU WOULD HAVE THE RIGHT TO SUE IN COURT AND HAVE A JURY TRIAL. The arbitration shall be commenced and conducted under the Commercial Arbitration Rules of the American Arbitration Association ("AAA") and, where appropriate, the AAA’s Supplementary Procedures for Consumer Related Disputes ("AAA Consumer Rules"), both of which are available at the American Arbitration Association (AAA) website. Your arbitration fees and your share of arbitrator compensation shall be governed by the AAA Consumer Rules and, where appropriate, limited by the AAA Consumer Rules. If such costs are determined by the arbitrator to be excessive, we will pay all arbitration fees and expenses. The arbitration may be conducted in person, through the submission of documents, by phone, or online. The arbitrator will make a decision in writing, but need not provide a statement of reasons unless requested by either Party. The arbitrator must follow applicable law, and any award may be challenged if the arbitrator fails to do so. Except where otherwise required by the applicable AAA rules or applicable law, the arbitration will take place in Williamson County, Texas. Except as otherwise provided herein, the Parties may litigate in court to compel arbitration, stay proceedings pending arbitration, or to confirm, modify, vacate, or enter judgment on the award entered by the arbitrator.

                    If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the state and federal courts located in Delaware county, Delaware, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction, and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Legal Terms.
                    ...
                    <p className={styles["body-subheading"]}>19. CORRECTIONS</p>
                    ...
                    <p className={styles["body-subheading"]}>20. DISCLAIMER</p>
                    ...
                    <p className={styles["body-subheading"]}>21. LIMITATIONS OF LIABILITY</p>
                    ...
                    <p className={styles["body-subheading"]}>22. INDEMNIFICATION</p>
                    ...
                    <p className={styles["body-subheading"]}>23. USER DATA</p>
                    ...
                    <p className={styles["body-subheading"]}>24. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</p>
                    ...
                    <p className={styles["body-subheading"]}>25. CALIFORNIA USERS AND RESIDENTS</p>
                    ...
                    <p className={styles["body-subheading"]}>26. MISCELLANEOUS</p>
                    ...
                    <p className={styles["body-subheading"]}>27. CONTACT US</p>

                    <br/>In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at:
